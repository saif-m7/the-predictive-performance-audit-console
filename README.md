...
The Predictive Performance Audit Console evaluates the performance and robustness of supervised classification algorithms.
...
The overfitting audit compares:
...
The target distribution is imbalanced, so F1-Score is used for cross-validation to provide a more meaningful evaluation of churn classification performance.
...
![Logistic Regression Confusion Matrix](outputs/figures/logistic_regression_confusion_matrix.png)
